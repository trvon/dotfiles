...
- `hermes/` - Hermes agent container, Matrix bridge, paperbridge config
- `SERVER.md` - small server/admin notes

## Main docs

- [pi/README.md](pi/README.md) - Pi setup and extension behavior
- [openclaw/README.md](openclaw/README.md) - OpenClaw container setup
- [hermes/README.md](hermes/README.md) - Hermes agent setup
- [openclaw/extensions/pi-context/README.md](openclaw/extensions/pi-context/README.md) - Pi-style OpenClaw plugin
- [windows/README.md](windows/README.md) - Windows notes
