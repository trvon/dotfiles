...
- `PI_PRIMARY_MODEL` (recommended `google/gemma-4-26B-A4B-it`; shared fallback default)
- `PI_HEALTH_WATCHDOG_VERIFIER_PROVIDER` (recommended `llama-cpp`)
- `PI_HEALTH_WATCHDOG_VERIFIER_MODEL` (recommended `openai/gpt-oss-20b`; defaults to `PI_PRIMARY_MODEL` if unset)
